 ...
 *
 * An implementation of the interface is explicity **not** responsible for
...
interface API {
   ...
   */
  getAppConfig(): Promise<API.AppConfig>;
   ...
   */
  createRun(options: API.CreateRunOptions): AsyncGenerator<API.RunEvent>;
   ...
   */
  continueRun(options: API.ContinueRunOptions): AsyncGenerator<API.RunEvent>;
   ...
   */
  listSessions(options: API.ListSessionsOptions): Promise<API.ListSessionsResult>;
   ...
   */
  getSession(options: API.GetSessionOptions): Promise<API.SessionDetail>;
   ...
   */
  getSessionRuns(options: API.GetSessionRunsOptions): Promise<readonly API.SessionRun[]>;
   ...
   */
  getMemories(options: API.GetMemoriesOptions): Promise<API.GetMemoriesResult>;
   ...
   */
  getAppMetrics(options: API.GetAppMetricsOptions): Promise<API.GetAppMetricsResult>;
}


/**
 * The namespace for the `API` statics.
 */
export
namespace API {
  /**
  ...
  /**
   * A type alias for the `API.createRun()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.continueRun()` options.
   */
  export
   ...
   *
   *
   * TODO - add more token breakout fields?
   */
  export
  type TokenMetrics = {
    /**
  ...
  /**
   * A type alias for the `API.listSessions()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.listSessions()` response.
   */
  export
  ...
  /**
   * A type alias for the `API.getSession()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.getSessionRuns()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.getMemories()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.getMemories()` result.
   */
  export
  ...
  /**
   * A type alias for the `API.getAppMetrics()` options.
   */
  export
  ...
  /**
   * A type alias for the `API.getAppMetrics()` result.
   */
  export
